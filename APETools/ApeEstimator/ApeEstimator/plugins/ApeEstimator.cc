...
//    const SiStripClusterInfo clusterInfo = SiStripClusterInfo(stripCluster, iSetup);
  //  const SiStripClusterInfo clusterInfo =SiStripClusterInfo(stripCluster,iSetup,stripCluster.geographicalId());
//    std::cout<<"before calling sistripclusterinfo"<<std::endl; 
    //const uint32_t detid =&stripCluster.geographicalId().rawId();
    //std::cout<<"after calling detid   "<<stripCluster.geographicalId().rawId()<<std::endl;
 
// const SiStripClusterInfo clusterInfo =SiStripClusterInfo(stripCluster,iSetup,stripCluster.geographicalId(),std::string(""));
 const SiStripClusterInfo clusterInfo =SiStripClusterInfo(stripCluster,iSetup,rawId,std::string(""));

//    std::cout<<" detid   "<<stripCluster.geographicalId()<<std::endl;
//    std::cout<<" detid   "<<rawId<<std::endl;


//     const SiStripClusterInfo clusterInfo =SiStripClusterInfo(stripCluster,iSetup,(int)stripCluster.geographicalId().rawId());
 
  //  std::cout<<"after calling sistripclusterinfo"<<std::endl;
...
//    std::cout<<"before signal over noise   "<<rawId<<std::endl;
    hitParams.sOverN          = clusterInfo.signalOverNoise();

//    std::cout<<"after  signal over noise  "<<clusterInfo.signalOverNoise()<<std::endl;
