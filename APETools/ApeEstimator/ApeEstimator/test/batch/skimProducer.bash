...
elif [[ "$sample" == qcd ]] ; then directory="/store/caf/user/ajkumar/mc/Summer12_v4/qcd/"
elif [[ "$sample" == wlnu ]] ; then directory="/store/caf/user/ajkumar/mc/Summer12_v4/wlnu/"
elif [[ "$sample" == zmumu10 ]] ; then directory="/store/caf/user/ajkumar/mc/Summer12_v4/zmumu10/"
elif [[ "$sample" == zmumu20 ]] ; then directory="/store/caf/user/ajkumar/mc/Summer12_v4/zmumu20/"
else
