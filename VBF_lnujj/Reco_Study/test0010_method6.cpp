...
//c++ -o test0010_method6 `root-config --glibs --cflags` -lm test0010_method6.cpp
/*
fourth method
...
//	   { // Find two vbf jets and two W jets
        ...
        if (tag_i_id!=-1&&tag_j_id!=-1&&wjj_a_id!=-1&&wjj_b_id!=-1 && vbf_lvjj_m>0 && vbf_lvjj_m>0 && vbf_lvj_m >30. && vbf_wjj_m >30. )
           { // Find two vbf jets and two W jets
