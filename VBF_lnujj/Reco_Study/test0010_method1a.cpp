//c++ -o test0010_method1a `root-config --glibs --cflags` -lm test0010_method1a.cpp
// c++ -o read_007 `root-config --glibs --cflags` -lm read_007.cpp
//  .read_007 /home/ajay/Work/LPC/Morion13/VBF/RD_mu_TTbar_CMSSW532.root

/*
method1a tag jets from whole eta region and from remaining two leading  jets in whole eta region as W jets 
*/
