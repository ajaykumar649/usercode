...
class kanamuon {
  public :
   ...
   // Declaration of leaf types
    ...
    Int_t           NumPhotons;
    Float_t         Photon_Et[8];   //[NumPhotons]
    Float_t         Photon_E[8];   //[NumPhotons]
    Float_t         Photon_Eta[8];   //[NumPhotons]
    Float_t         Photon_Phi[8];   //[NumPhotons]
    Float_t         Photon_Theta[8];   //[NumPhotons]
    Float_t         Photon_Px[8];   //[NumPhotons]
    Float_t         Photon_Py[8];   //[NumPhotons]
    Float_t         Photon_Pz[8];   //[NumPhotons]
    Float_t         Photon_Vx[8];   //[NumPhotons]
    Float_t         Photon_Vy[8];   //[NumPhotons]
    Float_t         Photon_Vz[8];   //[NumPhotons]
    Float_t         Photon_SC_Et[8];   //[NumPhotons]
    Float_t         Photon_SC_E[8];   //[NumPhotons]
    Float_t         Photon_SC_Eta[8];   //[NumPhotons]
    Float_t         Photon_SC_Phi[8];   //[NumPhotons]
    Float_t         Photon_SC_Theta[8];   //[NumPhotons]
    Float_t         Photon_SC_x[8];   //[NumPhotons]
    Float_t         Photon_SC_y[8];   //[NumPhotons]
    Float_t         Photon_SC_z[8];   //[NumPhotons]
    Float_t         PFisocharged03[8];   //[NumPhotons]
    Float_t         PFisophoton03[8];   //[NumPhotons]
    Float_t         PFisoneutral03[8];   //[NumPhotons]
    Float_t         Photon_HoverE[8];   //[NumPhotons]
    Float_t         Photon_HoverE2011[8];   //[NumPhotons]
    Float_t         Photon_SigmaIetaIeta[8];   //[NumPhotons]
    Int_t           Photon_hasPixelSeed[8];   //[NumPhotons]
    Int_t           Photon_passElecVeto[8];   //[NumPhotons]
    Int_t           Photon_Id2011[8];   //[NumPhotons]
    Int_t           Photon_Id2012[8];   //[NumPhotons]
    Float_t         W_mass;
    Float_t         W_mt;
    Float_t         W_mtMVA;
    Float_t         W_px;
...
// used to generate this class and read the Tree.
  if (tree == 0) {
    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/uscms/store/user/lnujj/HCP2012/MergedNtuples/mu_TTbar_CMSSW532.root");
    if (!f) {
      f = new TFile("/eos/uscms/store/user/lnujj/HCP2012/MergedNtuples/mu_TTbar_CMSSW532.root");
    }
