...
//#include "ClassifierOut/TMVAClassification_125_nJ2_el_Likelihood.class.C"
//#include "ClassifierOut/TMVAClassification_125_VBF_el_BDT.class.C"
//#include "ClassifierOut/TMVAClassification_125_VBF_el_Likelihood.class.C"
#include "ClassifierOut/TMVAClassification_BDT.class_ggh_el.C"
#include "ClassifierOut/TMVAClassification_BDT.class_vbf_el.C"
...
//const TString inQCDDir = "/uscmst1b_scratch/lpc1/3DayLifetime/jdamgov/HCPlnjj/MergedNtuples/";
const TString outDataDir = "/uscms_data/d3/ajay/Higgs125/nTuples_RD/CMSSW_5_3_2_patch4/src/ElectroWeakAnalysis/VPlusJets/test/RD_for_training/";
...
void kanaelec::myana(double myflag, bool isQCD, int runflag)
{
   ...
   if (myflag == 20120000 || myflag == -100){
      ...
      if ( !isQCD ) {
         InitCounters( inDataDir + "QCD_WenuJets_DataAll_GoldenJSON_11p9invfb.root", h_events, h_events_weighted);
         myChain->Add(                    inDataDir + "QCD_WenuJets_DataAll_GoldenJSON_11p9invfb.root"); 
         Init(myChain);Loop( h_events, h_events_weighted, 20120000,runflag, outDataDir + "RD_QCD_WenuJets_DataAll_GoldenJSON_11p9invfb");
      } else {
         InitCounters( inDataDir + "QCD_WenuJets_DataAll_GoldenJSON_11p9invfb.root", h_events, h_events_weighted);
         myChain->Add(                    inQCDDir +     "QCD_WenuJets_DataAll_GoldenJSON_11p9invfb.root");
         Init(myChain);Loop( h_events, h_events_weighted, 20120000,runflag, outDataDir + "RDQCD_WenuJets_DataAll_GoldenJSON_11p9invfb", isQCD);
      }
   }
...
void kanaelec::Loop(TH1F* h_events, TH1F* h_events_weighted, int wda, int runflag, const char *outfilename, bool isQCD)
{
   ...
   Int_t gg125evt =0, qq125evt =0;

   TBranch *branch_ggdevt= newtree->Branch("ggdevt",    &ggdevt,     "ggdevt/I");
   TBranch *branch_evtNJ = newtree->Branch("evtNJ",     &evtNJ,      "evtNJ/I");
   TBranch *branch_gg125evt= newtree->Branch("gg125evt",    &gg125evt,     "gg125evt/I");
   TBranch *branch_qq125evt= newtree->Branch("qq125evt",    &qq125evt,     "qq125evt/I");
...
//  Int_t Indexmax_mvaout[2];

  Float_t ggh125_ang_ha   = 999, ggh125_ang_hb = 999, ggh125_ang_hs = 999, ggh125_ang_phi = 999, ggh125_ang_phia = 999, ggh125_ang_phib = 999;
  Float_t ggh125_Mlvjj = 999, ggh125_ptlvjj =-999,  ggh125_ylvjj = -999, ggh125_philvjj = -999;

//   float       GenMlvjj=999;

   Float_t qqh125_ang_ha   = 999, qqh125_ang_hb = 999, qqh125_ang_hs = 999, qqh125_ang_phi = 999, qqh125_ang_phia = 999, qqh125_ang_phib = 999;
   Float_t      qqh125_Mlvjj = 999, qqh125_ptlvjj =-999,  qqh125_ylvjj = -999, qqh125_philvjj = -999;

   float       dPhi_lep_dijet=999;
   float       vbfdPhi_lep_dijet=999;

  Float_t mvacombin_2j125el[6][6];
  Float_t mvavbf_comb_2j125el[6][6];

//  Int_t Indexmax_mvaout[2];
   Float_t max_mvaout125el;
   Float_t max_mvaoutvbf125el;

   Float_t mva2j125el = 999,mva2j160el = 999, mva2j170el = 999, mva2j180el = 999, mva2j190el = 999, mva2j200el = 999, mva2j250el = 999, mva2j300el = 999, mva2j350el = 999, mva2j400el = 999, mva2j450el = 999, mva2j500el = 999, mva2j550el = 999, mva2j600el = 999;
   ...
   Float_t  mvavbf125el = 999, mvavbf160el = 999, mvavbf170el = 999, mvavbf180el = 999, mvavbf190el = 999, mvavbf200el = 999, mvavbf250el = 999, mvavbf300el = 999, mvavbf350el = 999, mvavbf400el = 999, mvavbf450el = 999, mvavbf500el = 999, mvavbf550el = 999, mvavbf600el = 999;


//	TBranch * branchGenlnujj = newtree->Branch("GenMlvjj",&GenMlvjj, "GenMlvjj/F");
//	TBranch * branchdeltaR1 = newtree->Branch("delta_R1",&delta_R1, "delta_R1/F");

//   TBranch * branch_2j125el   =  newtree->Branch("mva2j125el",   &mva2j125el,    "mva2j125el/F");

   TBranch * branch_comb_2j125el =  newtree->Branch("mvacombin_2j125el",   &mvacombin_2j125el,    "mvacombin_2j125el[15]/F");
   TBranch * branch_max_mvaout125el = newtree->Branch("max_mvaout125el",   &max_mvaout125el,  "max_mvaout125el/F");
   TBranch * branch_mvavbf_comb_2j125el   =  newtree->Branch("mvavbf_comb_2j125el",   &mvavbf_comb_2j125el,    "mvavbf_comb_2j125el[15]/F");
   TBranch * branch_max_mvaoutvbf125el = newtree->Branch("max_mvaoutvbf125el",   &max_mvaoutvbf125el,  "max_mvaoutvbf125el/F");

   TBranch * branch_ggh125_Mlnujj = newtree->Branch("ggh125_Mlvjj",&ggh125_Mlvjj, "ggh125_Mlvjj/F");
   TBranch * branch_qqh125_Mlnujj = newtree->Branch("qqh125_Mlvjj",&qqh125_Mlvjj, "qqh125_Mlvjj/F");

   TBranch * branch_ggh125_ha   =  newtree->Branch("ggh125_ang_ha",   &ggh125_ang_ha,    "ggh125_ang_ha/F");
   TBranch * branch_ggh125_hb   =  newtree->Branch("ggh125_ang_hb",   &ggh125_ang_hb,    "ggh125_ang_hb/F");
   TBranch * branch_ggh125_hs   =  newtree->Branch("ggh125_ang_hs",   &ggh125_ang_hs,    "ggh125_ang_hs/F");
   TBranch * branch_ggh125_phi  =  newtree->Branch("ggh125_ang_phi",  &ggh125_ang_phi,   "ggh125_ang_phi/F");
   TBranch * branch_ggh125_phia =  newtree->Branch("ggh125_ang_phia", &ggh125_ang_phia,  "ggh125_ang_phia/F");
   TBranch * branch_ggh125_phib =  newtree->Branch("ggh125_ang_phib", &ggh125_ang_phib,  "ggh125_ang_phib/F");
   
   TBranch * branch_ggh125_orgpt=  newtree->Branch("ggh125_ptlvjj",   &ggh125_ptlvjj,    "ggh125_ptlvjj/F");
   TBranch * branch_ggh125_orgy =  newtree->Branch("ggh125_ylvjj",    &ggh125_ylvjj,     "ggh125_ylvjj/F");
   TBranch * branch_ggh125_orgph=  newtree->Branch("ggh125_philvjj",  &ggh125_philvjj,   "ggh125_philvjj/F");

   TBranch * branch_qqh125_ha   =  newtree->Branch("qqh125_ang_ha",  &qqh125_ang_ha,    "qqh125_ang_ha/F");
   TBranch * branch_qqh125_hb   =  newtree->Branch("qqh125_ang_hb",   &qqh125_ang_hb,    "qqh125_ang_hb/F");
   TBranch * branch_qqh125_hs   =  newtree->Branch("qqh125_ang_hs",   &qqh125_ang_hs,    "qqh125_ang_hs/F");
   TBranch * branch_qqh125_phi  =  newtree->Branch("qqh125_ang_phi",  &qqh125_ang_phi,   "qqh125_ang_phi/F");
   TBranch * branch_qqh125_phia =  newtree->Branch("qqh125_ang_phia", &qqh125_ang_phia,  "qqh125_ang_phia/F");
   TBranch * branch_qqh125_phib =  newtree->Branch("qqh125_ang_phib", &qqh125_ang_phib,  "qqh125_ang_phib/F");

   TBranch * branch_qqh125_orgpt=  newtree->Branch("qqh125_ptlvjj",   &qqh125_ptlvjj,    "qqh125_ptlvjj/F"); 
   TBranch * branch_qqh125_orgy =  newtree->Branch("qqh125_ylvjj",    &qqh125_ylvjj,     "qqh125_ylvjj/F");
   TBranch * branch_qqh125_orgph=  newtree->Branch("qqh125_philvjj",  &qqh125_philvjj,   "qqh125_philvjj/F");



//   TBranch * branch_2j125mu   =  newtree->Branch("mva2j125mu",   &mva2j125mu,    "mva2j125mu/F");
   ...
   TBranch * branch_vbf125el   =  newtree->Branch("mvavbf125el",   &mvavbf125el,    "mvavbf125el/F");
   ...
   //ReadMVA2j125el mvaReader2j125el( inputVarsMVA );
   ...
   // the training input variables ggh125
      const char* ggh125_inputVars[] = { "Mrecojet_pt[0]", "Mrecojet_eta[0]", "Mrecojet_phi[0]", "Mrecojet_E[0]", "Mrecojet_pt[1]", "Mrecojet_eta[1]", "Mrecojet_phi[1]", "Mrecojet_E[1]", "MrecoMet_pt", "MrecoMet_phi", "dPhi_lep_dijet" };
 //const std::vector<double>& inputValuesMVA;
   std::vector<std::string> ggh125_inputVarsMVA;
   for (int i=0; i<11; ++i) ggh125_inputVarsMVA.push_back( ggh125_inputVars[i] );
  
	ReadBDTgghel mvaReaderggh125el ( ggh125_inputVarsMVA );

       const char* qqh125_inputVars[] = { "Mrecojet_pt[0]", "Mrecojet_eta[0]", "Mrecojet_phi[0]", "Mrecojet_E[0]", "Mrecojet_pt[1]", "Mrecojet_eta[1]", "Mrecojet_phi[1]", "Mrecojet_E[1]", "MrecoMet_pt", "MrecoMet_phi", "dPhi_lep_dijet" };
 //const std::vector<double>& inputValuesMVA;
   std::vector<std::string> qqh125_inputVarsMVA;
   for (int i=0; i<11; ++i) qqh125_inputVarsMVA.push_back( qqh125_inputVars[i] );

        ReadBDTvbfel mvaReaderqqh125el ( qqh125_inputVarsMVA );
   ...
   //ReadMVAVBF125el mvaReadervbf125el( vbf_inputVarsMVA );
...
//        int   count3 =0;
        ...
        vector<double> max_mvaout;
        max_mvaout.clear();

       vector<double> max_mvaoutvbf;
        max_mvaoutvbf.clear();
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
    ...
    // mvacombin_2j125el = 999; 

   mvacombin_2j125el[6][6]= {-10};
   //Indexmax_mvaout[2] = {-1,-1};
   max_mvaout125el = 999;

   mvavbf_comb_2j125el[6][6]= {-10};
   max_mvaoutvbf125el = 999;

   mva2j125el = 999;    mva2j160el = 999; mva2j170el = 999; mva2j180el = 999; mva2j190el = 999; mva2j200el = 999; mva2j250el = 999; mva2j300el = 999; mva2j350el = 999; mva2j400el = 999; mva2j450el = 999; mva2j500el = 999; mva2j550el = 999; mva2j600el = 999;
    ...
    mvavbf125el = 999;  mvavbf160el = 999; mvavbf170el = 999; mvavbf180el = 999; mvavbf190el = 999; mvavbf200el = 999; mvavbf250el = 999; mvavbf300el = 999; mvavbf350el = 999; mvavbf400el = 999; mvavbf450el = 999; mvavbf500el = 999; mvavbf550el = 999; mvavbf600el = 999;
...
//for (!nentries==0){}
float greatest = -10.;
int  Indexmax_mvaout[2] = {-1,-1};

        vector<double> ggh125_inputVarsMVAvalue;
        vector<double> qqh125_inputVarsMVAvalue;

        for(unsigned int l=0; l<jetsize;l++)
	{	
		if ( abs(JetPFCor_Phi[l]) <2.5)
		{	
		        for(unsigned int m=l+1; m<jetsize;m++)
			{
				if ( abs(JetPFCor_Phi[m]) <2.5)
				{	
/*		        		Mrecojet_pt[0] = JetPFCor_Pt[l];
					Mrecojet_eta[0] = JetPFCor_Eta[l];
					Mrecojet_phi[0] = JetPFCor_Phi[l];
					Mrecojet_E[0] = JetPFCor_E[l];
					Mrecojet_pt[1] = JetPFCor_Pt[m];
					Mrecojet_eta[1] = JetPFCor_Eta[m];
					Mrecojet_phi[1] = JetPFCor_Phi[m];
					Mrecojet_E[1] = JetPFCor_E[m];
*/
                   TLorentzVector leading_jet_p;
                   leading_jet_p.SetPtEtaPhiE(JetPFCor_Pt[l], JetPFCor_Eta[l], JetPFCor_Phi[l], JetPFCor_E[l]);
                   TLorentzVector nextleading_jet_p;
                   nextleading_jet_p.SetPtEtaPhiE(JetPFCor_Pt[m], JetPFCor_Eta[m], JetPFCor_Phi[m], JetPFCor_E[m]);
               	   TLorentzVector dijet_p;
		   dijet_p = leading_jet_p+nextleading_jet_p;

                                        float Phi_dijet_p = dijet_p.Phi();
					dPhi_lep_dijet = signed_delta_phi(Phi_dijet_p, W_electron_phi);

		                        //pfMet......................................below
//                		       MrecoMet_pt = event_met_pfmet;
//		                       MrecoMet_phi = event_met_pfmetPhi;
                		        // MVAMet................................below..
//		                       MrecoMet_pt = event_metMVA_met;
  //              		       MrecoMet_phi = event_metMVA_metPhi;
   
					ggh125_inputVarsMVAvalue.clear();

				        ggh125_inputVarsMVAvalue.push_back( JetPFCor_Pt[l]);
				        ggh125_inputVarsMVAvalue.push_back(JetPFCor_Eta[l] );
				        ggh125_inputVarsMVAvalue.push_back( JetPFCor_Phi[l] );
				        ggh125_inputVarsMVAvalue.push_back( JetPFCor_E[l] );
				        ggh125_inputVarsMVAvalue.push_back(JetPFCor_Pt[m] );
				        ggh125_inputVarsMVAvalue.push_back(JetPFCor_Eta[m] );
				        ggh125_inputVarsMVAvalue.push_back( JetPFCor_Phi[m]);
				        ggh125_inputVarsMVAvalue.push_back(JetPFCor_E[m] );
				        ggh125_inputVarsMVAvalue.push_back(  event_met_pfmet );
				        ggh125_inputVarsMVAvalue.push_back( event_met_pfmetPhi );
				        ggh125_inputVarsMVAvalue.push_back( dPhi_lep_dijet );

				        mvacombin_2j125el[l][m] =  mvaReaderggh125el.GetMvaValue( ggh125_inputVarsMVAvalue );
	       			 float newmax = find_max(greatest, mvacombin_2j125el[l][m]);
				 greatest = newmax;

				if (greatest == mvacombin_2j125el[l][m]){
//				if (sqrt(pow(W_Parton_eta[j]-JetPFCor_Eta[k],2)+pow(delta_phij,2))<0.3)
                                //gg125evt = gg125evt+1;
                                max_mvaout125el=greatest;
				Indexmax_mvaout[0] = l;
				Indexmax_mvaout[1] =m;}

//				        cout<<"event "<<jentry<<"mvaout  "<<mvacombin_2j125el[l][m]<<endl;
				}	
			}			
		}
	}

max_mvaout.push_back(greatest);

if (Indexmax_mvaout[0] != -1 && Indexmax_mvaout[1] !=-1){
if ( W_electron_pt >30. && JetPFCor_Pt[Indexmax_mvaout[0]] >20. && JetPFCor_Pt[Indexmax_mvaout[1]] >20. && event_met_pfmet >20.){
//cout<<" "<<jentry<<" greatest "<<max_mvaout.at(jentry)<<"   "<<Indexmax_mvaout[0]<<"  "<<Indexmax_mvaout[1]<<" "<<MatchedRecoJetIndex[0]<<" "<<MatchedRecoJetIndex[1]<<"    "<<Index[0]<<"   "<<Index[1]<<endl;
count1 = count1+1;
gg125evt =1;
			TLorentzVector leading_lepton;
			leading_lepton.SetPtEtaPhiE(W_electron_pt, W_electron_eta, W_electron_phi, W_electron_e);

			TLorentzVector leading_jet;
			leading_jet.SetPtEtaPhiE(JetPFCor_Pt[Indexmax_mvaout[0]], JetPFCor_Eta[Indexmax_mvaout[0]], JetPFCor_Phi[Indexmax_mvaout[0]], JetPFCor_E[Indexmax_mvaout[0]]);

			TLorentzVector nextleading_jet;
			nextleading_jet.SetPtEtaPhiE(JetPFCor_Pt[Indexmax_mvaout[1]], JetPFCor_Eta[Indexmax_mvaout[1]], JetPFCor_Phi[Indexmax_mvaout[1]], JetPFCor_E[Indexmax_mvaout[1]]);

//			TLorentzVector dijet;
//			dijet = leading_jet+nextleading_jet;

			TLorentzVector v4;
//			v4.SetPtEtaPhiM(event_metMVA_met, 0., event_metMVA_metPhi, 0.);
                        v4.SetPtEtaPhiM(event_met_pfmet, 0., event_met_pfmetPhi, 0.);
			ggh125_Mlvjj = (leading_lepton+leading_jet+nextleading_jet+v4).M(); 
	                ggh125_ptlvjj   = (leading_lepton+leading_jet+nextleading_jet+v4).Pt();
		        ggh125_ylvjj    = (leading_lepton+leading_jet+nextleading_jet+v4).Rapidity();
           	        ggh125_philvjj  = (leading_lepton+leading_jet+nextleading_jet+v4).Phi();

	         double a_costheta1, a_costheta2, a_phi, a_costhetastar, a_phistar1, a_phistar2;
         if (W_electron_charge < 0){
            calculateAngles(leading_lepton, v4, leading_jet, nextleading_jet, a_costheta1, a_costheta2, a_phi, a_costhetastar, a_phistar1, a_phistar2);
         }
         else{
            calculateAngles(v4, leading_lepton, leading_jet, nextleading_jet, a_costheta1, a_costheta2, a_phi, a_costhetastar, a_phistar1, a_phistar2);
         }
         ggh125_ang_ha = a_costheta1; ggh125_ang_hb = fabs(a_costheta2); ggh125_ang_hs = a_costhetastar;  ggh125_ang_phi = a_phi; ggh125_ang_phia = a_phistar1; ggh125_ang_phib = a_phistar2;



      		//	dPhi_lep_dijet = dijet.Phi();

}//int count2 = 0;
}

//cout<<"count1  "<<count1<<"  gg125evt  "<<gg125evt<<endl;
...
//:::::::::::::::::::::::::::::::::::::::::::::::;end:::::::::::::::::::::::::::::::;;
      ...
      if ( !isQCD ) {
         ...
         if ( !( (-1.<W_electron_mvaTrigV0) )  ) isgengdevt=0;
               if ( !( (0.3<W_electron_pfIsoEA) )  ) isgengdevt=0;
      }
      ...
      if (isgengdevt) { ggdevt = 4;// Do the kinematic fit for all event!!!
         ...
         //mva2j125el = (float) mvaReader2j125el.GetMvaValue( mvaInputVal );
...
float vbfgreatest = -10.;
int  Indexmax_mvaoutvbf[2] = {-1,-1};

        vector<double> vbf125_inputVarsMVAvalue;
        for(unsigned int l=0; l<jetsize;l++)
        {
                if ( abs(JetPFCor_Phi[l]) <2.5)
                {
                        for(unsigned int m=l+1; m<jetsize;m++)
                        {
                          ...
                          /*              Mrecojet_pt[0] = JetPFCor_Pt[l];
                                        ...
                                        Mrecojet_E[1] = JetPFCor_E[m];
*/
                   TLorentzVector vbf_jet1_p;
                   vbf_jet1_p.SetPtEtaPhiE(JetPFCor_Pt[l], JetPFCor_Eta[l], JetPFCor_Phi[l], JetPFCor_E[l]);
                   TLorentzVector vbf_jet2_p;
                   vbf_jet2_p.SetPtEtaPhiE(JetPFCor_Pt[m], JetPFCor_Eta[m], JetPFCor_Phi[m], JetPFCor_E[m]);
                   TLorentzVector vbf_dijet_p;
                   vbf_dijet_p = vbf_jet1_p+vbf_jet2_p;

                                        float Phi_vbfdijet_p = vbf_dijet_p.Phi();
                                        vbfdPhi_lep_dijet = signed_delta_phi(Phi_vbfdijet_p, W_electron_phi);
...
//                                     MrecoMet_pt = event_metMVA_met;
  //                                   MrecoMet_phi = event_metMVA_metPhi;
                                        qqh125_inputVarsMVAvalue.clear();
                                        qqh125_inputVarsMVAvalue.push_back(  JetPFCor_Pt[l] );
                                        qqh125_inputVarsMVAvalue.push_back(JetPFCor_Eta[l] );
                                        qqh125_inputVarsMVAvalue.push_back( JetPFCor_Phi[l] );
                                        qqh125_inputVarsMVAvalue.push_back( JetPFCor_E[l] );
                                        qqh125_inputVarsMVAvalue.push_back(JetPFCor_Pt[m] );
                                        qqh125_inputVarsMVAvalue.push_back(JetPFCor_Eta[m] );
                                        qqh125_inputVarsMVAvalue.push_back( JetPFCor_Phi[m]);
                                        qqh125_inputVarsMVAvalue.push_back(JetPFCor_E[m] );
                                        qqh125_inputVarsMVAvalue.push_back( event_met_pfmet );
                                        qqh125_inputVarsMVAvalue.push_back( event_met_pfmetPhi );
                                        qqh125_inputVarsMVAvalue.push_back( vbfdPhi_lep_dijet );

                                        mvavbf_comb_2j125el[l][m] =  mvaReaderqqh125el.GetMvaValue( qqh125_inputVarsMVAvalue );
                                 float newmax = find_max(greatest, mvavbf_comb_2j125el[l][m]);
                                 vbfgreatest = newmax;

                                if (vbfgreatest == mvavbf_comb_2j125el[l][m]){
//                              if (sqrt(pow(W_Parton_eta[j]-JetPFCor_Eta[k],2)+pow(delta_phij,2))<0.3)
                                //gg125evt = gg125evt+1;
                                max_mvaoutvbf125el=vbfgreatest;
                                Indexmax_mvaoutvbf[0] = l;
                                Indexmax_mvaoutvbf[1] =m;}

//                                      cout<<"event "<<jentry<<"mvaout  "<<mvavbf_comb_2j125el[l][m]<<endl;
                                }
                        }
                }
        }

max_mvaoutvbf.push_back(vbfgreatest);

if (Indexmax_mvaoutvbf[0] != -1 && Indexmax_mvaoutvbf[1] !=-1){
if ( W_electron_pt >30. && JetPFCor_Pt[Indexmax_mvaoutvbf[0]] >20. && JetPFCor_Pt[Indexmax_mvaoutvbf[1]] >20. && event_met_pfmet >20.){

cout<<" "<<jentry<<" greatest "<<max_mvaoutvbf.at(jentry)<<"   "<<Indexmax_mvaoutvbf[0]<<"  "<<Indexmax_mvaoutvbf[1]<<endl;


vbfcount1 = vbfcount1+1;
qq125evt =1;
                        TLorentzVector vbf_lepton;
                        vbf_lepton.SetPtEtaPhiE(W_electron_pt, W_electron_eta, W_electron_phi, W_electron_e);

                        TLorentzVector vbf1_jet;
                        vbf1_jet.SetPtEtaPhiE(JetPFCor_Pt[Indexmax_mvaoutvbf[0]], JetPFCor_Eta[Indexmax_mvaoutvbf[0]], JetPFCor_Phi[Indexmax_mvaoutvbf[0]], JetPFCor_E[Indexmax_mvaoutvbf[0]]);

                        TLorentzVector vbf2_jet;
                        vbf2_jet.SetPtEtaPhiE(JetPFCor_Pt[Indexmax_mvaoutvbf[1]], JetPFCor_Eta[Indexmax_mvaoutvbf[1]], JetPFCor_Phi[Indexmax_mvaoutvbf[1]], JetPFCor_E[Indexmax_mvaoutvbf[1]]);

//                      TLorentzVector dijet;
//                      dijet = leading_jet+nextleading_jet;

                        TLorentzVector vbfv4;
//                      v4.SetPtEtaPhiM(event_metMVA_met, 0., event_metMVA_metPhi, 0.);
                        vbfv4.SetPtEtaPhiM(event_met_pfmet, 0., event_met_pfmetPhi, 0.);
                        qqh125_Mlvjj = (vbf_lepton+vbf1_jet+vbf2_jet+vbfv4).M();
           		qqh125_ptlvjj     = (vbf_lepton+vbfv4+vbf1_jet+vbf2_jet).Pt();
	                //qqh125_eta    = (mup+b_nvp+wjj_ajp+wjj_bjp).Eta();
            		qqh125_philvjj    = (vbf_lepton+vbfv4+vbf1_jet+vbf2_jet).Phi();
		        qqh125_ylvjj      = (vbf_lepton+vbfv4+vbf1_jet+vbf2_jet).Rapidity();


            double a_costheta1, a_costheta2, a_phi, a_costhetastar, a_phistar1, a_phistar2;
            if (W_electron_charge < 0){
               calculateAngles(vbf_lepton, vbfv4, vbf1_jet, vbf2_jet, a_costheta1, a_costheta2, a_phi, a_costhetastar, a_phistar1, a_phistar2);
            }
            else{
               calculateAngles(vbfv4, vbf_lepton, vbf1_jet, vbf2_jet, a_costheta1, a_costheta2, a_phi, a_costhetastar, a_phistar1, a_phistar2);
            }
            qqh125_ang_ha = a_costheta1; qqh125_ang_hb = fabs(a_costheta2); qqh125_ang_hs = a_costhetastar;  qqh125_ang_phi = a_phi; qqh125_ang_phia = a_phistar1; qqh125_ang_phib = a_phistar2;


}//int count2 = 0;
}

//cout<<"qqcount1  "<<count1<<"  qq125evt  "<<qq125evt<<endl;
...
//:::::::::::::::::::::::::::::::::::::::::::::::;end:::::::::::::::::::::::::::::::;;
         ...
         if (tag_i_id!=-1&&tag_j_id!=-1&&wjj_a_id!=-1&&wjj_b_id!=-1){            // 5.  Find two vbf jets and two W jets
            ...
            //mvavbf125el = (float) mvaReadervbf125el.GetMvaValue( vbf_mvaInputVal );
      ...
      branch_ggdevt->Fill();
      branch_evtNJ ->Fill();
      branch_gg125evt->Fill();
      branch_qq125evt->Fill();
...
//:::::::::::::::::::::::::::::::::::::::::::::::::
        branch_max_mvaout125el->Fill();
        branch_max_mvaoutvbf125el->Fill();
        //branch_index125el->Fill();
//        branch_2j125el->Fill();

        branch_comb_2j125el->Fill();
        branch_mvavbf_comb_2j125el->Fill();

      branch_ggh125_Mlnujj->Fill();
      branch_ggh125_ha->Fill();
      branch_ggh125_hb->Fill();
      branch_ggh125_hs->Fill();
      branch_ggh125_phi->Fill();
      branch_ggh125_phia->Fill();
      branch_ggh125_phib->Fill();
//      branch_orgm->Fill();
      branch_ggh125_orgpt->Fill();
      branch_ggh125_orgy->Fill();
      branch_ggh125_orgph->Fill();

      branch_qqh125_Mlnujj->Fill();
      branch_qqh125_ha->Fill();
      branch_qqh125_hb->Fill();
      branch_qqh125_hs->Fill();
      branch_qqh125_phi->Fill();
      branch_qqh125_phia->Fill();
      branch_qqh125_phib->Fill();
//      branch_orgm->Fill();
      branch_qqh125_orgpt->Fill();
      branch_qqh125_orgy->Fill();
      branch_qqh125_orgph->Fill();
...
float kanaelec::find_max ( float a, float b)
{ if (a > b) return a;
else return b;
}


		float kanaelec::signed_delta_phi(float phi1, float phi2)
		{
