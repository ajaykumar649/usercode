void MyRunMuon(double myflag=20112250, bool isQCD=false, int runflag=0)
{
  ...
  gROOT->ProcessLine(".L ClassifierOut/TMVAClassification_125_nJ2_mu_Likelihood.class.C+");
  gROOT->ProcessLine(".L ClassifierOut/TMVAClassification_125_VBF_mu_Likelihood.class.C+");
  gROOT->ProcessLine(".L ClassifierOut/TMVAClassification_BDT.class_ggh_mu.C+");
  gROOT->ProcessLine(".L ClassifierOut/TMVAClassification_BDT.class_vbf_mu.C+");
